...
Description: jQuery Validation JS file for HW4 Part 1. This is where the user will validate the inputs.
*/
...
$(document).ready(function() {
    ...
    // if all of the form inputs are valid, generate the table
